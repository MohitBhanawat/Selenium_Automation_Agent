...
import com.smartqa.automationagent.CommandProcessor;
...
import com.smartqa.automationagent.webdriven.WebDriverCommandProcessor;
...
import org.smartqa.automationagent.remote.http.FormEncodedData;
...
import org.smartqa.automationagent.remote.server.ActiveSessionFactory;
import org.smartqa.automationagent.remote.server.ActiveSessionListener;
...
/**
 * An implementation of the original automationagent rc server endpoint, using a webdriver-backed automationagent
...
public class WebDriverBackedSeleniumHandler implements Routable {
  ...
  private static final Logger LOG = Logger.getLogger(WebDriverBackedAutomationAgent.class.getName());
  ...
  public boolean matches(HttpRequest req) {
    return req.getMethod() == POST &&
           ("/automationagent-server/driver/".equals(req.getUri()) ||
            "/automationagent-server/driver".equals(req.getUri()));
  }
