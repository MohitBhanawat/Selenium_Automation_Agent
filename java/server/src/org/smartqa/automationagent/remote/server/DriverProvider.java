...
/**
 * Classes that implement this interface are used by {org.smartqa.automationagent.remote.server.DriverFactory}
 ...
 *
 * AutomationAgent Server trusts the driver providers, it does not check that a driver provider actually
