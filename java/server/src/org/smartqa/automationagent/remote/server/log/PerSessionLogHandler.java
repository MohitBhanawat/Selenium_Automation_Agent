...
public class PerSessionLogHandler extends java.util.logging.Handler {
   ...
   *
   * The logging is globally added to the jvm and is effectively used by both classic automationagent and
   * WebDriver.
   *
  ...
  /**
   * This returns AutomationAgent Remote Control logs associated with the sessionId.
   *
