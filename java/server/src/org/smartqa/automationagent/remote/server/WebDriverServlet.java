...
import org.smartqa.automationagent.grid.server.JeeInterop;
...
import org.smartqa.automationagent.remote.server.commandhandler.ExceptionHandler;
...
import org.smartqa.automationagent.remote.server.xdrpc.CrossDomainRpc;
import org.smartqa.automationagent.remote.server.xdrpc.CrossDomainRpcLoader;
  ...
  private void handle(HttpServletRequest req, HttpServletResponse resp) {
    ...
    Future<?> execution = executor.submit(() -> {
      ...
      try {
        ...
        Thread.currentThread().setName("AutomationAgent WebDriver Servlet - Quiescent Thread");
