...
/**
 * A data model class for the results of the AutomationAgent HTMLRunner (aka TestRunner, FITRunner)
 *
...
public class HTMLTestResults {
  ...
  private static final String SUMMARY_HTML =
      ...
      "<tr>\n<td>AutomationAgent Version:</td>\n<td>{8}</td>\n</tr>\n" +
      "<tr>\n<td>AutomationAgent Revision:</td>\n<td>{9}</td>\n</tr>\n" +
      "<tr>\n<td>{10}</td>\n<td>&nbsp;</td>\n</tr>\n</table>";
