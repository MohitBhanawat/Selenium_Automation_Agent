...
package org.smartqa.automationagent.grid;

/**
 * The AutomationAgent Grid is composed of a number of moving pieces, all of which are
 * designed to be used either locally or across an HTTP boundary.
 * <p>
 * Sitting at the front of the system is the
 * {@link org.smartqa.automationagent.grid.router.Router}. This is responsible for
 ...
 * {@link org.smartqa.automationagent.grid.distributor.Distributor}.
 * <p>
 * The {@code Distributor} has a number of
 * {@link org.smartqa.automationagent.grid.node.Node}s associated with it, each of which
 * is capable of running one or more {@link org.smartqa.automationagent.grid.data.Session}s
 ...
 * {@link org.smartqa.automationagent.grid.sessionmap.SessionMap} where the {@code Session}
 * (identified by its {@link org.smartqa.automationagent.remote.SessionId} can be
