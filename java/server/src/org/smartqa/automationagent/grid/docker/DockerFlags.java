...
package org.smartqa.automationagent.grid.docker;
...
import org.smartqa.automationagent.grid.config.ConfigValue;
...
public class DockerFlags implements HasRoles {
  ...
  @Parameter(
      ...
      description = "Docker configs which map image name to stereotype capabilities (example " +
                    "`-D automationagent/standalone-firefox:latest '{\"browserName\": \"firefox\"}')",
      arity = 2,
      variableArity = true)
  @ConfigValue(
    section = "docker",
    name = "configs",
    example = "[\"automationagent/standalone-firefox:latest\", \"{\\\"browserName\\\": \\\"firefox\\\"}\"]")
