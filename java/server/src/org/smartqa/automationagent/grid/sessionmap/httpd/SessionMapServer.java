...
package org.smartqa.automationagent.grid.sessionmap.httpd;
...
public class SessionMapServer extends TemplateGridCommand {
  ...
  public String getDescription() {
    return "Adds this server as the session map in a automationagent grid.";
  }
  ...
  protected void execute(Config config) {
    ...
    LOG.info(String.format(
      "Started AutomationAgent session map %s (revision %s): %s",
