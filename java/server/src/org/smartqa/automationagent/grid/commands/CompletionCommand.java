...
import org.smartqa.automationagent.grid.config.DescribedOption;
import org.smartqa.automationagent.grid.config.Role;
import org.smartqa.automationagent.grid.server.HelpFlags;

import static java.util.stream.Collectors.joining;
import static org.smartqa.automationagent.grid.config.StandardGridRoles.ALL_ROLES;
...
public class CompletionCommand implements CliCommand {
  ...
  private void outputZshCompletions(PrintStream out) {
    ...
    out.println("#compdef automationagent");
