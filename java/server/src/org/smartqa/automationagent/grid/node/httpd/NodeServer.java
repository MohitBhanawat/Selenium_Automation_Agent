...
package org.smartqa.automationagent.grid.node.httpd;
...
import org.smartqa.automationagent.grid.data.NodeStatusEvent;
import org.smartqa.automationagent.grid.log.LoggingOptions;
import org.smartqa.automationagent.grid.node.Node;
import org.smartqa.automationagent.grid.node.ProxyNodeCdp;
...
import static org.smartqa.automationagent.grid.config.StandardGridRoles.EVENT_BUS_ROLE;
import static org.smartqa.automationagent.grid.config.StandardGridRoles.HTTPD_ROLE;
import static org.smartqa.automationagent.grid.config.StandardGridRoles.NODE_ROLE;
import static org.smartqa.automationagent.grid.data.NodeAddedEvent.NODE_ADDED;
...
public class NodeServer extends TemplateGridCommand {
  ...
  public String getDescription() {
    return "Adds this server as a node in the automationagent grid.";
  }
  ...
  protected void execute(Config config) {
    ...
    LOG.info(String.format(
      "Started AutomationAgent node %s (revision %s): %s",
