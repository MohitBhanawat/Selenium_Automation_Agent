...
package org.smartqa.automationagent.grid.distributor.httpd;
...
public class DistributorServer extends TemplateGridCommand {
  ...
  private static final String LOCAL_DISTRIBUTOR_SERVER = "org.smartqa.automationagent.grid.distributor.local.LocalDistributor";
  ...
  public String getDescription() {
    return "Adds this server as the distributor in a automationagent grid.";
  }
  ...
  protected void execute(Config config) {
    ...
    LOG.info(String.format(
      "Started AutomationAgent distributor %s (revision %s): %s",
