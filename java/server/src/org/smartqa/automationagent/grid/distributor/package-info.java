...
/**
 * The {@link org.smartqa.automationagent.grid.distributor.Distributor} is responsible
 * for assigning new calls to Create Session to a
 * {@link org.smartqa.automationagent.grid.node.Node}. It's possible that the first
