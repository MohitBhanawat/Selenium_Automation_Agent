...
import static org.smartqa.automationagent.grid.distributor.local.Host.Status.DOWN;
import static org.smartqa.automationagent.grid.distributor.local.Host.Status.DRAINING;
import static org.smartqa.automationagent.grid.distributor.local.Host.Status.UP;
import static org.smartqa.automationagent.grid.distributor.local.Slot.Status.ACTIVE;
import static org.smartqa.automationagent.grid.distributor.local.Slot.Status.AVAILABLE;
...
class Host {
  ...
  private static final Logger LOG = Logger.getLogger("AutomationAgent Host");
