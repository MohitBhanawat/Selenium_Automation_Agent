...
import org.smartqa.automationagent.cli.WrappedPrintWriter;
...
public class Main {
  ...
  private static class Help implements CliCommand {
    ...
    public String getName() {
      return "AutomationAgent Server commands";
    }
    ...
    public String getDescription() {
      return "A list of all the commands available. To use one, run `java -jar automationagent.jar " +
             "commandName`.";
    }
    ...
    public Executable configure(PrintStream out, PrintStream err, String... args) {
      return () -> {
        ...
        outWriter.write(String.format(
            "\n  java -jar automationagent.jar --ext example.jar%sdir standalone --port 1234",
            File.pathSeparator));
        out.println("\n");
      };
    }
