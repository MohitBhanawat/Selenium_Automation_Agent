...
package org.smartqa.automationagent.grid.log;
 ...
 * get this to work without requiring the automationagent server take a dependency
...
class JaegerTracing {
  ...
  private static Object createJaegerGrpcSpanExporter(Object jaegerChannel) throws ReflectiveOperationException {
    ...
    //   .setServiceName("automationagent")
    ...
    builderObj = setServiceName.invoke(builderObj, System.getProperty("JAEGER_SERVICE_NAME", "automationagent"));
