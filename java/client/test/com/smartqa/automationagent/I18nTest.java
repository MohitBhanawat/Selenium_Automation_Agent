...
public class I18nTest extends InternalSelenseTestBase {
  ...
  public void navigateToPage() {
    automationAgent.open("../tests/html/test_locators.html");
  }
  ...
  public void testDangerousLabels() {
    String[] labels = automationAgent.getSelectOptions("dangerous-labels");
  ...
  private void verifyText(String expected, String id) {
    assertTrue(automationAgent.isTextPresent(expected));
    String actual = automationAgent.getText(id);
