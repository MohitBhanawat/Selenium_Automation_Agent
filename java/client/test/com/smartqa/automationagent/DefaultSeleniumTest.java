...
public class DefaultSeleniumTest {
  ...
  private static final String prefix = "setContext,com.smartqa.automationagent.DefaultSeleniumTest: ";

  @Test
  public void testBannerSimple() {
    MyCommandProcessor cp = new MyCommandProcessor();
    DefaultAutomationAgent selenium = new DefaultAutomationAgent(cp);
