...
/**
 * Regression test suite for stability problems discovered in AutomationAgent Remote Control
 *
...
public class StabilityTest extends InternalSelenseTestBase {
  ...
  public void assumeSeCoreImplementation() {
    assumeFalse(automationAgent instanceof WrapsDriver);
  }

  @Test
  public void retrieveLastRemoteControlLogsDoesNotTriggerOutOfMemoryErrors() {
    for (int i = 1; i < 100000; i++) {
      automationAgent.retrieveLastRemoteControlLogs();
    }
  }
