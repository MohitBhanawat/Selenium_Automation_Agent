...
import com.smartqa.automationagent.webdriven.CompoundMutator;
import com.smartqa.automationagent.webdriven.ScriptMutator;
...
public class CompoundMutatorTest {
  ...
  public void testReplacesReferencesViaSeleniumToDocument() {
    ...
    mutator.mutate("return automationagent.browserbot.getDocument()", builder);
    String script = builder.toString();

    assertTrue(script, script.contains("automationagent.browserbot = {}"));
    assertTrue(script, script.contains("automationagent = {}"));
