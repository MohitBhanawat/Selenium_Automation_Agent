...
public class ScriptMutatorTest extends JUnit4TestBase {
  ...
  public void testShouldBeAbleToUseTheBrowserbot() {
    ...
    AutomationAgent automationAgent = new WebDriverBackedAutomationAgent(driver, url);
    automationAgent.open(pages.tables);

    String rowCount = automationAgent.getEval(
        "var table = automationagent.browserbot.findElement('id=base'); " +
