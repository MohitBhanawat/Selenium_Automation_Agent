...
import com.smartqa.automationagent.webdriven.VariableDeclaration;

@RunWith(JUnit4.class)
public class VariableDeclarationTest {

  private static final String REPLACEMENT = "automationagent.browserbot = {};";
  ...
  public void setUp() {
    declaration = new VariableDeclaration(
        "automationagent.browserbot", REPLACEMENT);
  }
  ...
  public void testShouldAddDeclarationIfNecesssary() {
    StringBuilder builder = new StringBuilder();
    declaration.mutate("automationagent.browserbot.findElement", builder);
  ...
  public void testReplacementStillHappensWithStrangeSpacing() {
    StringBuilder builder = new StringBuilder();
    declaration.mutate("automationagent   \n\n\n .browserbot .findCheese", builder);
