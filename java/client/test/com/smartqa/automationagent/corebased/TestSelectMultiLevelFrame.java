...
public class TestSelectMultiLevelFrame extends InternalSelenseTestBase {
  ...
  public void testSelectMultiLevelFrame() {
    automationAgent.open("test_multi_level_frame.html");
    // Select first level frame
    automationAgent.selectFrame("frame2");
    automationAgent.selectFrame("theFrame");
    assertTrue(automationAgent.isTextPresent("Click here for next page via absolute link"));
  }
}
