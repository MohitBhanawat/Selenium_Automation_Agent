...
public class TestDojoDragAndDrop extends InternalSelenseTestBase {
  ...
  public void testDojoDragAndDrop() {
    automationAgent.open("dojo-0.4.0-mini/tests/dnd/test_simple.html");
    automationAgent.dragAndDropToObject("1_3", "2_1");
    assertTrue(automationAgent.isTextPresent("either side of me*list 1 item 3"));
  }
}
