...
public class TestDragAndDrop extends InternalSelenseTestBase {
  ...
  public void testDragAndDrop() {
    automationAgent.open("slider/example.html");
    automationAgent.dragdrop("id=slider01", "800,0");
    assertEquals(automationAgent.getValue("id=output1"), "20");
    automationAgent.dragdrop("id=slider01", "-800,0");
    assertEquals(automationAgent.getValue("id=output1"), "0");
  }
}
