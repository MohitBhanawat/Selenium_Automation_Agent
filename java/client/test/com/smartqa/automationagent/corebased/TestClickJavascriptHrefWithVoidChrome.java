...
public class TestClickJavascriptHrefWithVoidChrome extends
  ...
  public void testClickJavascriptHrefWithVoidChrome() {
    automationAgent.open("test_click_javascript_href_void_chrome.html");
    automationAgent.click("linkWithJavascriptVoidHref");
    verifyEquals(automationAgent.getAlert(), "onclick:voidHref");
    automationAgent.click("changeHref");
    verifyEquals(automationAgent.getAlert(), "changeHref");
    automationAgent.click("deleteElement");
    verifyFalse(automationAgent.isElementPresent("deleteElement"));
