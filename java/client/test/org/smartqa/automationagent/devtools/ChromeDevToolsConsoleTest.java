...
import static org.smartqa.automationagent.devtools.console.Console.disable;
import static org.smartqa.automationagent.devtools.console.Console.enable;
import static org.smartqa.automationagent.devtools.console.Console.messageAdded;
...
public class ChromeDevToolsConsoleTest extends DevToolsTestBase {
  ...
  public void verifyMessageAdded() {
    ...
    String consoleMessage = "Hello AutomationAgent";
