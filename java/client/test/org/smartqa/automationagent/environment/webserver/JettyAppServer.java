...
public class JettyAppServer implements AppServer {
  ...
  public JettyAppServer(String hostName, int httpPort, int httpsPort) {
    ...
    Path runfiles = InProjectLocate.findRunfilesRoot();
    if (runfiles != null) {
  ...
  protected Path getKeyStore() {
    return InProjectLocate
        .locate("java/client/test/org/smartqa/automationagent/environment/webserver/keystore");
  }
