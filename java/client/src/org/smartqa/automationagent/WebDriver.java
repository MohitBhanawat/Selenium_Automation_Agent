...
public interface WebDriver extends SearchContext {
   ...
   * for {@link org.smartqa.automationagent.WebDriver.Navigation#to(String)}.
   * <p>
   ...
   * @see org.smartqa.automationagent.PageLoadStrategy
   */
  void get(String url);
   ...
   * @see org.smartqa.automationagent.By
   * @see org.smartqa.automationagent.WebDriver.Timeouts
   */
  @Override
   ...
   * @see org.smartqa.automationagent.WebDriver.TargetLocator
   */
   ...
   * URL.
   *
   * @return A {@link org.smartqa.automationagent.WebDriver.Navigation} that allows the selection of what to
   *         do next
   */
  Navigation navigate();
   ...
   * @see org.smartqa.automationagent.WebDriver.Options
   */
  Options manage();
