...
public abstract class By {
	...
	public abstract static class StandardLocator extends By {
		...
		public abstract <T extends SearchContext> WebElement findElement(T driver,
				BiFunction<String, String, WebElement> finder);

		public abstract <T extends SearchContext> List<WebElement> findElements(T driver,
	...
	public static class ByClassName extends StandardLocator implements Serializable {
		 ...
		 * private Map<String, Object> toJson() { Map<String, Object> asJson = new
		 * HashMap<>(); asJson.put("using", "link text"); asJson.put("value", linkText);
		 * return Collections.unmodifiableMap(asJson); }
		 * 
