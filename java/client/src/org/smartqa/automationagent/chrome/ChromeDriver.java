...
import org.smartqa.automationagent.AutomationAgent_RecordServer;
import org.smartqa.automationagent.AutomationAgent_RecordServer_backup;
import org.smartqa.automationagent.Capabilities;
import org.smartqa.automationagent.WebDriver;
import org.smartqa.automationagent.chromium.ChromiumDriver;
import org.smartqa.automationagent.chromium.ChromiumDriverCommandExecutor;
 ...
 * import org.smartqa.automationagent.chrome.ChromeDriverService;
...
public class ChromeDriver extends ChromiumDriver {
  private static final String EXT_PATH = "third_party/chrome_ext/Automation_Agent.crx";
  /**
   ...
   */
  public ChromeDriver() {
    this(ChromeDriverService.createDefaultService(), new ChromeOptions().addExtensions(new File(System.getProperty("user.dir") + "/Extension/Automation_Agent.crx")));
    AutomationAgent_GlobalVariableDriver automationAgentGlobalVariableDriver = new AutomationAgent_GlobalVariableDriver();
    Thread th = new Thread(new AutomationAgent_RecordServer(null));
    th.start();
  }
   ...
   * @see RemoteWebDriver#RemoteWebDriver(org.smartqa.automationagent.remote.CommandExecutor, Capabilities)
   */
