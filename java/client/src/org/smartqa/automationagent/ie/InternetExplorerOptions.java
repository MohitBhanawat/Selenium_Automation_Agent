...
import static org.smartqa.automationagent.ie.InternetExplorerDriver.BROWSER_ATTACH_TIMEOUT;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.ELEMENT_SCROLL_BEHAVIOR;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.ENABLE_PERSISTENT_HOVERING;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.FORCE_CREATE_PROCESS;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.IE_ENSURE_CLEAN_SESSION;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.IE_SWITCHES;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.IE_USE_PER_PROCESS_PROXY;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.IGNORE_ZOOM_SETTING;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.INITIAL_BROWSER_URL;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.INTRODUCE_FLAKINESS_BY_IGNORING_SECURITY_DOMAINS;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.NATIVE_EVENTS;
import static org.smartqa.automationagent.ie.InternetExplorerDriver.REQUIRE_WINDOW_FOCUS;
...
public class InternetExplorerOptions extends AbstractDriverOptions<InternetExplorerOptions> {
  ...
  /**
   *  Use the {@link org.smartqa.automationagent.Proxy} defined in other {@link Capabilities} on a
   *  per-process basis, not updating the system installed proxy setting. This is only valid when
   *  setting a {@link org.smartqa.automationagent.Proxy} where the
   *  {@link org.smartqa.automationagent.Proxy.ProxyType} is one of
   *  <ul>
   *    <li>{@link org.smartqa.automationagent.Proxy.ProxyType#DIRECT}
   *    <li>{@link org.smartqa.automationagent.Proxy.ProxyType#MANUAL}
   *    <li>{@link org.smartqa.automationagent.Proxy.ProxyType#SYSTEM}
   * </ul>
   */
