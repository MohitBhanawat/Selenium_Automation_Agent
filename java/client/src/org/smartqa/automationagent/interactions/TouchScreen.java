...
public interface TouchScreen {
   ...
   *
   * @param where The location on the screen. Typically a {@link org.smartqa.automationagent.WebElement}
   */
   ...
   *
   * @param where the location where the scroll starts, usually a {@link org.smartqa.automationagent.WebElement}.
