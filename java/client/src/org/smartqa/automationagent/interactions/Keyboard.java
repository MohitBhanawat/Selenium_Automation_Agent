...
public interface Keyboard {
   ...
   *
   * Special keys that are not text, represented as {@link org.smartqa.automationagent.Keys} are recognized
  ...
  /**
   * Press a key on the keyboard that isn't text.  Please see {@link org.smartqa.automationagent.Keys} for
  ...
  /**
   * Release a key on the keyboard that isn't text.  Please see {@link org.smartqa.automationagent.Keys} for
   * an exhaustive list of recognized pressable keys.
   *
