...
public class LogLevelMapping {
  ...
  /**
   * Normalizes the given level to one of those supported by AutomationAgent.
   *
   * @param level log level to normalize
   * @return the automationagent supported corresponding log level
   */
  ...
  /**
   * Converts the JDK level to a name supported by AutomationAgent.
   *
   * @param level log level to get the string name of
   * @return string name representation of the level automationagent supports
   */
