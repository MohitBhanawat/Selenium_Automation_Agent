...
package org.smartqa.automationagent.support.events;
...
public interface WebDriverEventListener {
  ...
  /**
   * Called before {@link org.smartqa.automationagent.WebDriver#get get(String url)} respectively
   * {@link org.smartqa.automationagent.WebDriver.Navigation#to navigate().to(String url)}.
   *
   * @param url URL
   * @param driver WebDriver
   */
  ...
  /**
   * Called after {@link org.smartqa.automationagent.WebDriver#get get(String url)} respectively
   * {@link org.smartqa.automationagent.WebDriver.Navigation#to navigate().to(String url)}. Not called, if an
   * exception is thrown.
   *
   * @param url URL
   * @param driver WebDriver
  ...
  /**
   * Called before {@link org.smartqa.automationagent.WebDriver.Navigation#back navigate().back()}.
   *
   * @param driver WebDriver
   */
  ...
  /**
   * Called after {@link org.smartqa.automationagent.WebDriver.Navigation navigate().back()}. Not called, if an
   * exception is thrown.
   *
   * @param driver WebDriver
   */
  ...
  /**
   * Called before {@link org.smartqa.automationagent.WebDriver.Navigation#forward navigate().forward()}.
   *
   * @param driver WebDriver
   */
  ...
  /**
   * Called after {@link org.smartqa.automationagent.WebDriver.Navigation#forward navigate().forward()}. Not called,
  ...
  /**
   * Called before {@link org.smartqa.automationagent.WebDriver.Navigation#refresh navigate().refresh()}.
   *
   * @param driver WebDriver
   */
  ...
  /**
   * Called after {@link org.smartqa.automationagent.WebDriver.Navigation#refresh navigate().refresh()}. Not called,
   * if an exception is thrown.
   *
   * @param driver WebDriver
   */
  ...
  /**
   * Called before {@link org.smartqa.automationagent.remote.RemoteWebDriver#executeScript(String, Object...)}
   *
   * @param driver WebDriver
  ...
  /**
   * Called after {@link org.smartqa.automationagent.remote.RemoteWebDriver#executeScript(String, Object...)}.
  ...
  /**
   * This action will be performed each time before {@link org.smartqa.automationagent.WebDriver.TargetLocator#window(String)}
   *
   * @param windowName The name of the window or the handle as returned by
   *                   {@link org.smartqa.automationagent.WebDriver#getWindowHandle()}
   *                   or <code>null</code> if switching to a new window created by
   *                   {@link org.smartqa.automationagent.WebDriver.TargetLocator#newWindow(WindowType)}
   * @param driver WebDriver
   */
  void beforeSwitchToWindow(String windowName, WebDriver driver);

  /**
   * This action will be performed each time after {@link org.smartqa.automationagent.WebDriver.TargetLocator#window(String)}
   *
   * @param windowName The name of the window or the handle as returned by
   *                   {@link org.smartqa.automationagent.WebDriver#getWindowHandle()}
   *                   or <code>null</code> if switching to a new window created by
  ...
  /**
   * Called before {@link org.smartqa.automationagent.TakesScreenshot#getScreenshotAs(OutputType)}
  ...
  /**
   * Called after {@link org.smartqa.automationagent.TakesScreenshot#getScreenshotAs(OutputType)}
