 ...
 * Provides methods to process {@link org.smartqa.automationagent.support.FindBy},
 * {@link org.smartqa.automationagent.support.FindBys} and
 * {@link org.smartqa.automationagent.support.FindAll} annotations.
 */
public abstract class AbstractAnnotations {

  /**
   * Defines how to transform given object (field, class, etc)
   * into {@link org.smartqa.automationagent.By} class used by webdriver to locate elements.
   *
   * @return By object
   */
