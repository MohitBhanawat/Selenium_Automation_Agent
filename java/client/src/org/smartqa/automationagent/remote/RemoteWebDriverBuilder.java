...
import org.smartqa.automationagent.remote.codec.w3c.W3CHttpResponseCodec;
...
/**
 * Create a new AutomationAgent session using the W3C WebDriver protocol. This class will not generate any
 ...
 * don't care which), but where either browser will use the given {@link org.smartqa.automationagent.Proxy}.
 * In addition, we've added some metadata to the session, setting the "{@code cloud.key}" to be the
 * secret passphrase of our account with the cloud "AutomationAgent as a Service" provider.
 * <p>
