...
package org.smartqa.automationagent.remote.codec.w3c;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import com.google.common.io.Resources;

import static org.smartqa.automationagent.remote.DriverCommand.ACCEPT_ALERT;
import static org.smartqa.automationagent.remote.DriverCommand.ACTIONS;
import static org.smartqa.automationagent.remote.DriverCommand.CLEAR_ACTIONS_STATE;
import static org.smartqa.automationagent.remote.DriverCommand.CLEAR_LOCAL_STORAGE;
import static org.smartqa.automationagent.remote.DriverCommand.CLEAR_SESSION_STORAGE;
import static org.smartqa.automationagent.remote.DriverCommand.CLICK;
import static org.smartqa.automationagent.remote.DriverCommand.DISMISS_ALERT;
import static org.smartqa.automationagent.remote.DriverCommand.DOUBLE_CLICK;
import static org.smartqa.automationagent.remote.DriverCommand.EXECUTE_ASYNC_SCRIPT;
import static org.smartqa.automationagent.remote.DriverCommand.EXECUTE_SCRIPT;
...
import static org.smartqa.automationagent.remote.DriverCommand.GET_ACTIVE_ELEMENT;
import static org.smartqa.automationagent.remote.DriverCommand.GET_ALERT_TEXT;
import static org.smartqa.automationagent.remote.DriverCommand.GET_AVAILABLE_LOG_TYPES;
import static org.smartqa.automationagent.remote.DriverCommand.GET_CURRENT_WINDOW_HANDLE;
import static org.smartqa.automationagent.remote.DriverCommand.GET_CURRENT_WINDOW_POSITION;
import static org.smartqa.automationagent.remote.DriverCommand.GET_CURRENT_WINDOW_SIZE;
import static org.smartqa.automationagent.remote.DriverCommand.GET_ELEMENT_ATTRIBUTE;
import static org.smartqa.automationagent.remote.DriverCommand.GET_ELEMENT_LOCATION;
import static org.smartqa.automationagent.remote.DriverCommand.GET_ELEMENT_LOCATION_ONCE_SCROLLED_INTO_VIEW;
...
import static org.smartqa.automationagent.remote.DriverCommand.GET_LOCAL_STORAGE_ITEM;
import static org.smartqa.automationagent.remote.DriverCommand.GET_LOCAL_STORAGE_KEYS;
import static org.smartqa.automationagent.remote.DriverCommand.GET_LOCAL_STORAGE_SIZE;
import static org.smartqa.automationagent.remote.DriverCommand.GET_LOG;
import static org.smartqa.automationagent.remote.DriverCommand.GET_PAGE_SOURCE;
import static org.smartqa.automationagent.remote.DriverCommand.GET_SESSION_STORAGE_ITEM;
import static org.smartqa.automationagent.remote.DriverCommand.GET_SESSION_STORAGE_KEYS;
import static org.smartqa.automationagent.remote.DriverCommand.GET_SESSION_STORAGE_SIZE;
import static org.smartqa.automationagent.remote.DriverCommand.GET_WINDOW_HANDLES;
import static org.smartqa.automationagent.remote.DriverCommand.IS_ELEMENT_DISPLAYED;
import static org.smartqa.automationagent.remote.DriverCommand.MAXIMIZE_CURRENT_WINDOW;
import static org.smartqa.automationagent.remote.DriverCommand.MINIMIZE_CURRENT_WINDOW;
import static org.smartqa.automationagent.remote.DriverCommand.MOUSE_DOWN;
import static org.smartqa.automationagent.remote.DriverCommand.MOUSE_UP;
import static org.smartqa.automationagent.remote.DriverCommand.MOVE_TO;
import static org.smartqa.automationagent.remote.DriverCommand.REMOVE_LOCAL_STORAGE_ITEM;
import static org.smartqa.automationagent.remote.DriverCommand.REMOVE_SESSION_STORAGE_ITEM;
import static org.smartqa.automationagent.remote.DriverCommand.SEND_KEYS_TO_ACTIVE_ELEMENT;
import static org.smartqa.automationagent.remote.DriverCommand.SEND_KEYS_TO_ELEMENT;
import static org.smartqa.automationagent.remote.DriverCommand.SET_ALERT_VALUE;
import static org.smartqa.automationagent.remote.DriverCommand.SET_CURRENT_WINDOW_POSITION;
import static org.smartqa.automationagent.remote.DriverCommand.SET_CURRENT_WINDOW_SIZE;
import static org.smartqa.automationagent.remote.DriverCommand.SET_LOCAL_STORAGE_ITEM;
import static org.smartqa.automationagent.remote.DriverCommand.SET_SESSION_STORAGE_ITEM;
import static org.smartqa.automationagent.remote.DriverCommand.SET_TIMEOUT;
import static org.smartqa.automationagent.remote.DriverCommand.SUBMIT_ELEMENT;
...
import org.smartqa.automationagent.InvalidSelectorException;
import org.smartqa.automationagent.WebDriverException;
import org.smartqa.automationagent.interactions.Interaction;
import org.smartqa.automationagent.interactions.KeyInput;
...
import org.smartqa.automationagent.remote.codec.AbstractHttpCommandCodec;
...
public class W3CHttpCommandCodec extends AbstractHttpCommandCodec {
  ...
  private Map<String, ?> executeAtom(String atomFileName, Object... args) {
    try {
      String scriptName = "/org/smartqa/automationagent/remote/" + atomFileName;
