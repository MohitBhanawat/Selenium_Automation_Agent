...
import org.smartqa.automationagent.remote.codec.AbstractHttpResponseCodec;

/**
 * A response codec that adheres to the AutomationAgent project's JSON/HTTP wire protocol.
 *
 * @see <a href="https://github.com/SeleniumHQ/automationagent/wiki/JsonWireProtocol"> JSON wire
 * protocol</a>
 */
