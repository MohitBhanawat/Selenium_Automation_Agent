...
import static org.smartqa.automationagent.json.Json.LIST_OF_MAPS_TYPE;
...
import org.smartqa.automationagent.json.JsonOutput;
import org.smartqa.automationagent.remote.session.CapabilitiesFilter;
import org.smartqa.automationagent.remote.session.CapabilityTransform;
import org.smartqa.automationagent.remote.session.ChromeFilter;
import org.smartqa.automationagent.remote.session.EdgeFilter;
import org.smartqa.automationagent.remote.session.FirefoxFilter;
import org.smartqa.automationagent.remote.session.InternetExplorerFilter;
import org.smartqa.automationagent.remote.session.OperaFilter;
import org.smartqa.automationagent.remote.session.ProxyTransform;
import org.smartqa.automationagent.remote.session.SafariFilter;
import org.smartqa.automationagent.remote.session.StripAnyPlatform;
import org.smartqa.automationagent.remote.session.W3CPlatformNameNormaliser;
