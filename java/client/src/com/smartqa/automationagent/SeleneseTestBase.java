...
/**
 * Provides a base class that implements some handy functionality for AutomationAgent testing (you are
...
public class SeleneseTestBase {
  ...
  /** Use this object to run all of your automationagent tests */
  protected AutomationAgent automationAgent;
   ...
   * @param url the baseUrl to use for your AutomationAgent tests
  ...
  protected String runtimeBrowserString() {
    String defaultBrowser = System.getProperty("automationagent.defaultBrowser");
  ...
  /**
   * Creates a new DefaultAutomationAgent object and starts it using the specified baseUrl and browser
  ...
  protected int getDefaultPort() {
    try {
      Class<?> c = Class.forName("org.smartqa.automationagent.server.RemoteControlConfiguration");
      ...
      return Integer.getInteger("automationagent.port", 4444).intValue();
    }
  }
  ...
  public void setUp(String url, String browserString, int port) {
    ...
    automationAgent = new DefaultAutomationAgent("localhost", port, browserString, url);
  ...
  public String getText() {
    return automationAgent.getEval("this.page().bodyText()");
  }
