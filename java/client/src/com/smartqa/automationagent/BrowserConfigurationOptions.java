...
/**
 * Contains parameters for a single AutomationAgent browser session.
 *
 * BrowserConfigurationOptions is used as an argument to {@code AutomationAgent.start()}. The parameters
