...
public class HttpCommandProcessor implements CommandProcessor {
   ...
   *        pointing at the AutomationAgent resources on this URL,
   */
  public HttpCommandProcessor(String serverHost, int serverPort, String browserStartCommand,
      String browserURL) {
    rcServerLocation = serverHost +
        ":" + Integer.toString(serverPort);
    this.pathToServlet = "http://" + rcServerLocation + "/automationagent-server/driver/";
   ...
   * URL for the browser.
   *
   * @param pathToServlet - the URL of the AutomationAgent Server Driver, e.g.
  ...
  public String doCommand(String commandName, String[] args) {
    ...
    if (result == null) {
      throw new NullPointerException("AutomationAgent Bug! result must not be null");
    }
