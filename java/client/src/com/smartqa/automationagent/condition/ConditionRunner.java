 ...
 * pieces that it needs to execute (e.g. an instance of {@link AutomationAgent}). This is achieved through
...
public interface ConditionRunner {
  ...
  interface Context {
    ...
    /**
     * @return the {@link AutomationAgent} associated with this instance. This method will almost always be
     * called by any {@link Condition#isTrue(ConditionRunner.Context)}.
     */
    AutomationAgent getSelenium();
