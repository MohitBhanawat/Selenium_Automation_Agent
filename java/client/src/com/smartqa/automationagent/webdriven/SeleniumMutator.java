...
/**
 * Add a function backed by the closure-based implementation of AutomationAgent Core.
 */
public class SeleniumMutator implements ScriptMutator {
  ...
  public void mutate(String script, StringBuilder appendTo) {
    ...
    // Alias the raw atom and set "this" to be the pre-declared automationagent object.
