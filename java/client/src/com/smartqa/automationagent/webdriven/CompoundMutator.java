...
public class CompoundMutator implements ScriptMutator {
  ...
  public CompoundMutator(String baseUrl) {
    addMutator(new VariableDeclaration("automationagent", "var automationagent = {};"));
    addMutator(new VariableDeclaration("automationagent.browserbot", "automationagent.browserbot = {};"));
    addMutator(new VariableDeclaration(
        "automationagent.browserbot.baseUrl", "automationagent.browserbot.baseUrl = '" + baseUrl + "';"));
    addMutator(new VariableDeclaration(
    ...
    addMutator(new FunctionDeclaration("automationagent.page",
        "if (!automationagent.browserbot) { automationagent.browserbot = {} }; return automationagent.browserbot;"));
    addMutator(new FunctionDeclaration("automationagent.browserbot.getCurrentWindow", "return window;"));
    addMutator(new FunctionDeclaration("automationagent.browserbot.getUserWindow", "return window;"));
    addMutator(new FunctionDeclaration("automationagent.page().getCurrentWindow", "return window;"));
    addMutator(new FunctionDeclaration("automationagent.browserbot.getDocument", "return document;"));
    addMutator(new FunctionDeclaration("automationagent.page().getDocument", "return document;"));

    JavascriptLibrary library = new JavascriptLibrary();

    addMutator(new SeleniumMutator("automationagent.getText",
        library.getSeleniumScript("getText.js")));
    addMutator(new SeleniumMutator("automationagent.isElementPresent",
        library.getSeleniumScript("isElementPresent.js")));
    addMutator(new SeleniumMutator("automationagent.isTextPresent",
        library.getSeleniumScript("isTextPresent.js")));
    addMutator(new SeleniumMutator("automationagent.isVisible",
        library.getSeleniumScript("isVisible.js")));
    addMutator(new SeleniumMutator("automationagent.browserbot.findElement",
