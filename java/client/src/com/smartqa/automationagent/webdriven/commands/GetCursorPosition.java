...
package com.smartqa.automationagent.webdriven.commands;
...
public class GetCursorPosition extends com.smartqa.automationagent.webdriven.SeleneseCommand<Number> {
  ...
  protected Number handleSeleneseCommand(WebDriver driver, String locator, String value) {
    ...
    // relevant snippet of code from the original automationagent core to implement this. What could
    // possibly go wrong?
