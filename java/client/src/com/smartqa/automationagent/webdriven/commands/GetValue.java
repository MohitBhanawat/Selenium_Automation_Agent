...
import com.smartqa.automationagent.webdriven.SeleneseCommand;
...
public class GetValue extends SeleneseCommand<String> {
  ...
  protected String handleSeleneseCommand(WebDriver driver, String locator, String ignored) {
    ...
    // Special-case handling for checkboxes and radio buttons: The AutomationAgent API returns "on" for
