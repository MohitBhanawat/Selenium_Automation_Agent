...
/**
 * Provides a JUnit TestCase base class that implements some handy functionality for AutomationAgent
...
public class SeleneseTestCase extends TestCase {
  ...
  public void setUp() throws Exception {
    stb.setUp();
    automationAgent = stb.automationAgent;
  }
  ...
  /**
   * Creates a new DefaultAutomationAgent object and starts it using the specified baseURL, browser string
   * and port
   *
   * @param url the baseUrl for your tests
   * @param browserString the browser to use, e.g. *firefox
   * @param port the port of AutomationAgent RC
   */
  ...
  protected void setTestContext() {
    automationAgent.setContext(this.getClass().getSimpleName() + "." + getName());
  }
  ...
  public void runBare() throws Throwable {
    ...
    try {
      ...
      if (automationAgent != null) {
        ...
        try {
          automationAgent.captureScreenshot(filename);
