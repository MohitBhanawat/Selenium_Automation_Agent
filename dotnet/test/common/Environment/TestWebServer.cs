...
namespace OpenQA.Selenium.Environment
{
    public class TestWebServer
    {
        ...
        private string standaloneTestJar = @"java/client/test/org/smartqa/automationagent/environment/appserver_deploy.jar";
                ...
                if (!File.Exists(Path.Combine(projectRootPath, standaloneTestJar)))
                {
                    throw new FileNotFoundException(
                        string.Format(
                            ...
                            standaloneTestJar,
                            "bazel build //java/client/test/org/smartqa/automationagent/environment:appserver_deploy.jar",
                            projectRootPath));
                }
