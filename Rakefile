...
task '//java/client/test/org/smartqa/automationagent/environment/webserver:webserver:uber' => [
  '//java/client/test/org/smartqa/automationagent/environment:webserver'
]
...
JAVA_RELEASE_TARGETS = %w[
  //java/client/src/org/smartqa/automationagent/chrome:chrome-maven-artifacts
  //java/client/src/org/smartqa/automationagent/chromium:chromium-maven-artifacts
  //java/client/src/org/smartqa/automationagent/devtools:devtools-maven-artifacts
  //java/client/src/org/smartqa/automationagent/edge/edgehtml:edgehtml-maven-artifacts
  //java/client/src/org/smartqa/automationagent/edge:edgeium-maven-artifacts
  //java/client/src/org/smartqa/automationagent/firefox/xpi:xpi-maven-artifacts
  //java/client/src/org/smartqa/automationagent/firefox:firefox-maven-artifacts
  //java/client/src/org/smartqa/automationagent/ie:ie-maven-artifacts
  //java/client/src/org/smartqa/automationagent/json:json-maven-artifacts
  //java/client/src/org/smartqa/automationagent/lift:lift-maven-artifacts
  //java/client/src/org/smartqa/automationagent/opera:opera-maven-artifacts
  //java/client/src/org/smartqa/automationagent/remote/http:http-maven-artifacts
  //java/client/src/org/smartqa/automationagent/remote:remote-maven-artifacts
  //java/client/src/org/smartqa/automationagent/safari:safari-maven-artifacts
  //java/client/src/org/smartqa/automationagent/support:support-maven-artifacts
  //java/client/src/org/smartqa/selenium:client-combined-maven-artifacts
  //java/client/src/org/smartqa/selenium:core-maven-artifacts
  //java/server/src/com/smartqa/automationagent/webdriven:webdriven-maven-artifacts
  //java/server/src/org/smartqa/automationagent/grid/sessionmap/redis:redis-maven-artifacts
  //java/server/src/org/smartqa/automationagent/grid:grid-maven-artifacts
]
...
task tests: [
  '//java/client/test/org/smartqa/automationagent/htmlunit:htmlunit',
  '//java/client/test/org/smartqa/automationagent/firefox:test-synthesized',
  '//java/client/test/org/smartqa/automationagent/ie:ie',
  '//java/client/test/org/smartqa/automationagent/chrome:chrome',
  '//java/client/test/org/smartqa/automationagent/edge:edge',
  '//java/client/test/org/smartqa/automationagent/opera:opera',
  '//java/client/test/org/smartqa/automationagent/support:small-tests',
  '//java/client/test/org/smartqa/automationagent/support:large-tests',
  '//java/client/test/org/smartqa/automationagent/remote:small-tests',
  '//java/server/test/org/smartqa/automationagent/remote/server/log:test',
  '//java/server/test/org/smartqa/automationagent/remote/server:small-tests'
]
task chrome: ['//java/client/src/org/smartqa/automationagent/chrome']
task grid: [:'selenium-server-standalone']
task ie: ['//java/client/src/org/smartqa/automationagent/ie']
task firefox: ['//java/client/src/org/smartqa/automationagent/firefox']
task remote: %i[remote_server remote_client]
task remote_client: ['//java/client/src/org/smartqa/automationagent/remote']
task remote_server: ['//java/server/src/org/smartqa/automationagent/remote/server']
task safari: ['//java/client/src/org/smartqa/automationagent/safari']
task selenium: ['//java/client/src/org/smartqa/selenium:core']
task support: [
  '//java/client/src/org/smartqa/automationagent/lift',
  '//java/client/src/org/smartqa/automationagent/support'
]

desc 'Build the standalone server'
task 'selenium-server-standalone' => '//java/server/src/org/smartqa/automationagent/grid:selenium_server_deploy.jar'
...
task test_chrome: ['//java/client/test/org/smartqa/automationagent/chrome:chrome:run']
task test_edge: ['//java/client/test/org/smartqa/automationagent/edge:edge:run']
...
task test_htmlunit: [
  '//java/client/test/org/smartqa/automationagent/htmlunit:htmlunit:run'
]
task test_grid: [
  '//java/server/test/org/smartqa/grid/common:common:run',
  '//java/server/test/org/smartqa/grid:grid:run',
  '//java/server/test/org/smartqa/grid/e2e:e2e:run',
  '//java/client/test/org/smartqa/automationagent/remote:remote-driver-grid-tests:run'
]
task test_ie: [
  '//cpp/iedriverserver:win32',
  '//cpp/iedriverserver:x64',
  '//java/client/test/org/smartqa/automationagent/ie:ie:run'
]
task test_jobbie: [:test_ie]
task test_firefox: ['//java/client/test/org/smartqa/automationagent/firefox:marionette:run']
task test_opera: ['//java/client/test/org/smartqa/automationagent/opera:opera:run']
task test_remote_server: [
  '//java/server/test/org/smartqa/automationagent/remote/server:small-tests:run',
  '//java/server/test/org/smartqa/automationagent/remote/server/log:test:run'
]
task test_remote: [
  '//java/client/test/org/smartqa/automationagent/json:small-tests:run',
  '//java/client/test/org/smartqa/automationagent/remote:common-tests:run',
  '//java/client/test/org/smartqa/automationagent/remote:client-tests:run',
  '//java/client/test/org/smartqa/automationagent/remote:remote-driver-tests:run',
  :test_remote_server
]
task test_safari: ['//java/client/test/org/smartqa/automationagent/safari:safari:run']
task test_support: [
  '//java/client/test/org/smartqa/automationagent/lift:lift:run',
  '//java/client/test/org/smartqa/automationagent/support:small-tests:run',
  '//java/client/test/org/smartqa/automationagent/support:large-tests:run'
]
...
task test_java: [
  '//java/client/test/org/smartqa/automationagent/atoms:test:run',
...
task test_java_small_tests: [
  '//java/client/test/org/smartqa/selenium:small-tests:run',
  '//java/client/test/org/smartqa/automationagent/json:small-tests:run',
  '//java/client/test/org/smartqa/automationagent/support:small-tests:run',
  '//java/client/test/org/smartqa/automationagent/remote:common-tests:run',
  '//java/client/test/org/smartqa/automationagent/remote:client-tests:run',
  '//java/server/test/org/smartqa/grid/automationagent/node:node:run',
  '//java/server/test/org/smartqa/grid/automationagent/proxy:proxy:run',
  '//java/server/test/org/smartqa/automationagent/remote/server:small-tests:run',
  '//java/server/test/org/smartqa/automationagent/remote/server/log:test:run'
]
...
task javadocs: %i[//java/server/src/org/smartqa/automationagent/grid:all-javadocs] do
  rm_rf 'build/javadoc'
  mkdir_p 'build/javadoc'

  out = Rake::Task['//java/server/src/org/smartqa/automationagent/grid:all-javadocs'].out
...
task 'prep-release-zip': [
  '//java/client/src/org/smartqa/selenium:client-zip',
  '//java/server/src/org/smartqa/automationagent/grid:server-zip',
  '//java/server/src/org/smartqa/automationagent/grid:selenium_server_deploy.jar',
  '//java/server/src/org/smartqa/automationagent/server/htmlrunner:selenium-runner_deploy.jar'
] do
  ...
  mkdir_p 'build/dist'
  File.delete
  cp Rake::Task['//java/server/src/org/smartqa/automationagent/grid:server-zip'].out, "build/dist/selenium-server-#{version}.zip", preserve: false
  chmod 0666, "build/dist/selenium-server-#{version}.zip"
  cp Rake::Task['//java/client/src/org/smartqa/selenium:client-zip'].out, "build/dist/selenium-java-#{version}.zip", preserve: false
  chmod 0666, "build/dist/selenium-java-#{version}.zip"
  cp Rake::Task['//java/server/src/org/smartqa/automationagent/grid:selenium_server_deploy.jar'].out, "build/dist/selenium-server-#{version}.jar", preserve: false
  chmod 0666, "build/dist/selenium-server-#{version}.jar"
  cp Rake::Task['//java/server/src/org/smartqa/automationagent/server/htmlrunner:selenium-runner_deploy.jar'].out, "build/dist/selenium-html-runner-#{version}.jar", preserve: false
...
task 'publish-maven': JAVA_RELEASE_TARGETS + %w[//java/server/src/org/smartqa/automationagent/server/htmlrunner:selenium-runner_deploy.jar] do
...
task 'selenium-java' => '//java/client/src/org/smartqa/selenium:client-combined'
...
namespace :py do
  task prep: [
    ...
    cp 'third_party/js/automationagent/webdriver.json', firefox_py_home + 'webdriver_prefs.json', verbose: true
